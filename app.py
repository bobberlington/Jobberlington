...
from credentials import resume, chatgpt_api
        ...
        if not debug:
            ...
            for job in jobs:
                ...
                if chatgpt_api is not None:
                    analysis = analyze_job_fit(job_title=job["title"], job_description=job["description"], resume=resume, years=years, blacklist=excluded_words)
                else:
                    analysis = None
                print(job["company"])
                print(job["title"])
                try:
                    ...
                    job_dict["years_of_experience"] = None
